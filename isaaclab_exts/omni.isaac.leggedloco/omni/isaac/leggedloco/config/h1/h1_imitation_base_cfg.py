...
from .motion_utils.motion_lib import MotionLib
import torch
import os


@configclass
class H1ImitationPPORunnerCfg(RslRlOnPolicyRunnerCfg):
...
class EventCfg:
    ...
    _init_motion = EventTerm(
        func=mdp.init_motion,
        mode="startup",
...
@configclass
class H1ImitationBaseRoughEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class H1ImitationBaseRoughEnvCfg_PLAY(H1ImitationBaseRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

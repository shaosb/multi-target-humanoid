...
class ObservationsCfg:
    ...
    @configclass
    class MultiCriticObsCfg(ObsGroup):
        height_scan = ObsTerm(
            func=mdp.height_scan,
            params={"sensor_cfg": SceneEntityCfg("height_scanner")},
            clip=(-1.0, 1.0),
    ...
    multi_critic: MultiCriticObsCfg = MultiCriticObsCfg()
...
@configclass
class H1MultiCriticEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class H1MultiCriticEnvCfg_PLAY(H1MultiCriticEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

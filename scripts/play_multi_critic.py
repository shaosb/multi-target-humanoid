...
def main():
    ...
    agent_cfg: RslRlMultiCriticVecEnvHistoryWrapper = cli_args.parse_rsl_rl_cfg(args_cli.task, args_cli)
    ...
    ppo_runner = OnPolicyRunnerMultiCritic(env, agent_cfg.to_dict(), log_dir=None, device=agent_cfg.device)
